...
var serviceAccount = require("../public/cert/serviceAccountKey.json");
admin.initializeApp({
...
router.post('/rsa/enc',function(req,res){
    ...
    var cipherText=rsa.encryptStringWithRsaPublicKey(req.body.text,'./public/cert/publicKey.PEM')
...
router.post('/rsa/dec',function(req,res){
    if (!req.body) return res.sendStatus(400)
    var plainText=rsa.decryptStringWithRsaPrivateKey(req.body.cipher,'./public/cert/privateKey.PEM')
